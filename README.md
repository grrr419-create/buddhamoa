...
비공개 통계 페이지는 `/stats/`에 있으며 Supabase Auth 이메일 로그인으로 보호됩니다. 조회 기간은
시작일~종료일로 선택하고, 분석 단위는 일/주/월로 바꿔 조회수 추이를 묶어 볼 수 있습니다. 같은
기간의 유입 도메인, 인기 페이지, UTM 캠페인, 기기 구분도 함께 확인할 수 있습니다. Supabase SQL
